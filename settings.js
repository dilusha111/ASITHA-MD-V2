...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=GzR2wZaS#azQB1QO_98jW_uuxEPKNxrU_g4-pFXSvhSV3FIisib8' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*IAM BUSY WAIT*" : process.env.ALIVE_MSG,
